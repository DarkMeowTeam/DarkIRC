...
public interface IRCClientProvider {
    ...
    /**
     * 向公共聊天频道发送一条消息
     * 注意: 发送消息前 请确保你已经登录 你可以使用 {@link #login(String, String, ClientBrandData, Consumer)} 进行登录
     *
     * @param message 消息内容
     */
    ...
    /**
     * 发送指令到服务端
     * 注意: 发送指令前 请确保你已经登录 你可以使用 {@link #login(String, String, ClientBrandData, Consumer)} 进行登录
     *
